...
function Modal({ children, onSubmit, defaultOpen, title, description }) {
  ...
  return (
    <AlertDialog.Root open={open} onOpenChange={setOpen}>
      ...
      <AlertDialog.Content className="bg-gray-900 rounded-lg shadow-lg border border-gray-700 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 p-5 focus:outline-none flex flex-col justify-between space-y-8">
